...
RWZ_VERSION="v0.3.0-beta1"
RWZ_TAR_GZ_FILE="rwz-0.3.0-beta1-x86_64-linux-gnu.tar.gz"
...
RWZ_MANIFEST_SIG_FILE="rwz-0.3.0-beta1-manifest.sha512sum.asc"
...
RWZ_MANIFEST_FILE="rwz-0.3.0-beta1-manifest.sha512sum"
